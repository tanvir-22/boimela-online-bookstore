    ...
    <main className="min-h-screen bg-[#F7F2E7] py-14">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="mt-3 font-['Inter'] text-[#1F3A2E]/60">
            Expand your bookstore with another masterpiece.
          </p>
        </motion.div>
          ...
          >
            <div className="grid gap-6">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <div className="flex items-center rounded-xl border border-[#1F3A2E]/10 px-4">
                  <BookOpenText className="text-[#C9A24B]" />
                  <input
                    type="number"
                    name="pages"
                    value={form.pages}
              ...
              <Button
                type="submit"
                disabled={saving}
                className="mt-6 h-14 rounded-xl bg-[#C9A24B] text-lg font-semibold text-[#1F3A2E] hover:bg-[#b9923e]"
              >
